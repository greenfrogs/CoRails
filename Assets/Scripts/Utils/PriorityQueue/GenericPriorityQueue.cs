...
namespace Utils.PriorityQueue {
    ...
    public sealed class GenericPriorityQueue<TItem, TPriority> : IFixedSizePriorityQueue<TItem, TPriority>, IEnumerable where TItem : GenericPriorityQueueNode<TPriority> {
